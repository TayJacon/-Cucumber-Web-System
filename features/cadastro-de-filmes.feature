...
Funcionalidade: Cadastro de filmes
    ...
    Esquema do Cenario: Campos obrigatórios
      ...
      exibe uma notificação para um usuário
    ...
    @dup_movie
    Cenario: Duplicado
      O gestor de catálogo tenta cadastrat um filme, porem o título
      já foi cadastrado em outro momento e o siste notifica o usuário
